...
macro "Copy Channel Colors/LUT from Image1 to Image2... [f1]" {
    // 1) 열려있는 이미지 목록
...
macro "Close all... [f3]" {
		//By Min Lee, For channel 3-6, find particles and plot max value in it.
		...
		run("Analyze Particles...", "size=0-16 pixel clear add stack");
		...
		roiManager("Measure");
		String.copyResults();
		Plot.create("Plot of Results", "Ch", "Max");
		Plot.add("Circle", Table.getColumn("Ch", "Results"), Table.getColumn("Max", "Results"));
